...
def train(epochs):
    ...
    train_ds, val_ds, class_names = data_load("D:/big data/my py program/cake&moon cake_tf2.3/split_data/train",
                                              "D:/big data/my py program/cake&moon cake_tf2.3/split_data/val", 224, 224, 16)
    print(class_names)
    # 加载模型
    ...
    model.save("D:/big data/my py program/cake&moon cake_tf2.3/models/mobilenet_cakes.h5")
    # 记录结束时间
    end_time = time()
